...
Package.on_use(function(api) {
  ...
  api.add_files(['client/router.coffee', 'client/new_collection_modal.coffee', 'client/admin_login.coffee', 'client/collection_view.coffee', 'client/document_view.coffee', 'client/lib/jquery.autosize.js', 'client/zma_helpers.coffee'], 'client');
