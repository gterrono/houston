...
Package.on_use(function(api) {
  ...
  api.use('bootstrap', ['client', 'server']);
  api.use(['templating'], 'client');

  // load html first, https://github.com/meteor/meteor/issues/282
  api.add_files('client/main.html', 'client');

  api.add_files(['client/style.css', 'client/admin_login.html', 'client/db_view.html', 'client/collection_view.html', 'client/document_view.html'], 'client');
